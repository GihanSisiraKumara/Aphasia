...
class Levelzeroseventhpage extends StatefulWidget {
  const Levelzeroseventhpage({super.key});

  @override
  State<Levelzeroseventhpage> createState() => _LevelzeroseventhpageState();
}

class _LevelzeroseventhpageState extends State<Levelzeroseventhpage> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Text(
                'Get the tongue out of the mouth and try to touch the lower end of the nose. Keep repeating the process for 10 times.',
                style: TextStyle(
                  fontSize: 16,
